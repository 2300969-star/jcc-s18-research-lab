...
// 输出 artifacts/results/model_results.json 供 public 前端使用
const fs = require('fs');
...
// ---------- 逐阵容计算 ----------
const Q = { S: 0, A: 1, B: 2 };
const currentOfficialLineups = currentLineups(lineup_list, ROOT);
...
ensureOutputDirs();
const prevPath = resultPath('model_results.json');
