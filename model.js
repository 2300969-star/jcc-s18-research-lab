...
// 最强组合：体系梯队（依据=官方同口径重评分 + 阵容发现模型）
const verdicts = [
  { tier: 'T0', family: '机甲核心体系', comps: ['输出流机甲蕾欧娜', '无情连打贾克斯', '秘卫斗士贾克斯', '黑客贾克斯', '机甲德莱文过渡'],
    reason: '模型新排序：后期输出流蕾欧娜2星 2634分为机甲壳最高上限；贾克斯3星机甲混沌 2489分紧随其后。官方贾克斯三套同口径 2168/1923/1698，仍是最稳上分线；德莱文负责前中期机甲过渡。结论从“只玩贾克斯”改为“机甲壳优先，蕾欧娜上限、贾克斯稳定、德莱文过渡”。' },
  { tier: 'T0', family: '九五经济体系', comps: ['小天才九五', '机甲秘术枪手', '九五平民枪手', '福牛混沌九五', '95秘卫枪手'],
    reason: '官方九五家族同口径 1595/1429/1366/1194/1186；发现模型里小天才佐伊九五仍命中后期Top3（佐伊3星 2067分）。这条线继续保留T0，但强度来自经济符文把五费二星密度堆起来，不是任意九五都自动强。' },
  { tier: 'T1', family: '决斗节奏体系', comps: ['超英决斗菲奥娜', '决斗薇恩', '登神决斗天使', '决斗剑姬', '源计划决斗亚索'],
    reason: '决斗仍是前中期最稳定节奏线：模型中期第1为超英决斗菲奥娜3星 1504分，官方决斗三套同口径 1548/1540/1367。排序改为菲奥娜/薇恩/天使优先，亚索偏过渡或补源计划；终局上限低于机甲和九五。' },
  { tier: 'T1.5', family: '超级英雄低费体系', comps: ['超英决斗菲奥娜', '超英猫咪', '超英伊泽瑞尔'],
    reason: '超级英雄外壳保留，但原猫咪/EZ不再作为T1主线。模型更支持把超英作为低费追三增伤壳，优先搭菲奥娜、凯尔、薇恩这类攻速C；猫咪/EZ降为有专属强化或天胡装备时再玩。' },
  { tier: 'T1.5', family: '怪兽/情报体系', comps: ['情报特工怪兽卡莎', '怪兽厄运小姐'],
    reason: '卡莎线保留为可玩分支：官方同口径 1336，高于怪兽厄运小姐944；发现模型后期卡莎3星 1816分仍可进Top候选。厄运小姐在单体木桩口径吃亏，8怪兽仍高度依赖【大怪兽来袭！】。' },
];
