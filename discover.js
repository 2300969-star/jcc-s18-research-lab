...
fs.writeFileSync(path.join(ROOT, 'discovery_results.json'), JSON.stringify(out, null, 1));
fs.writeFileSync(path.join(ROOT, '可视化', 'discovery-data.js'), 'window.DISCOVERY=' + JSON.stringify(out) + ';');
writeReport(out);
