...
if (typeof module === "object" && module.exports && require.main === module) {
  ...
  const routeData = JSON.parse(fs.readFileSync(path.join(__dirname, "../../生成产物/结果/star-god-lineup-model.json"), "utf8"));
  const catalog = JSON.parse(fs.readFileSync(path.join(__dirname, "../../资源/游戏数据/star-god/17.7/catalog.json"), "utf8"));
  const fixtures = JSON.parse(fs.readFileSync(path.join(__dirname, "../../工程/测试/样本/star-god-hands.json"), "utf8"));
