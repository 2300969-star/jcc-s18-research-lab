...
const MatcherCore = require(path.join(root, "应用", "前端", "matcher-core.js"));
const MatchSessionCore = require(path.join(root, "应用", "前端", "match-session-core.js"));
const matcherData = require(path.join(root, "生成产物", "结果", "stage2_matcher_results.json"));
const hands = require(path.join(root, "工程", "测试", "样本", "hands.json"));
const oddsData = require(path.join(root, "应用", "前端", "odds-data.js"));
const mechanismData = require(path.join(root, "应用", "前端", "mechanism-data.js"));
