...
const readData = name => JSON.parse(fs.readFileSync(path.join(ROOT, "资源", "游戏数据", name), "utf8"));
...
function buildCatalog() {
  ...
  const ruleset = JSON.parse(fs.readFileSync(path.join(ROOT, "资源", "游戏数据", "ruleset", "monster-invasion-17.7.json"), "utf8"));
  ...
  return {
    ...
    source: {
      local: ["资源/游戏数据/galaxy.js", "资源/游戏数据/monster.js", "资源/游戏数据/hex.js", "资源/游戏数据/equip.js", "资源/游戏数据/chess.js", "资源/游戏数据/race.js", "资源/游戏数据/job.js", "资源/游戏数据/ruleset/monster-invasion-17.7.json"],
