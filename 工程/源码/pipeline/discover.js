...
const D = p => JSON.parse(fs.readFileSync(path.join(ROOT, '资源', '游戏数据', p), 'utf8')).data;
...
function shopModel(stageComps) {
  ...
  return {
    ...
    targetHits,
    evidence: {
      source: '资源/游戏数据/ruleset/monster-invasion-17.7.json',
...
console.log('输出: 生成产物/结果/discovery_results.json, 应用/前端/discovery-data.js, 文档/研究报告/阵容发现研究.md');
